...
unique_ptr<WindowClass> WindowClass::sInstance = nullptr;
HWND WindowClass::mhMainWnd = nullptr;
HINSTANCE WindowClass::mhAppInst = nullptr;
...
{
	return WindowClass::sInstance->MsgProc(hwnd, msg, wParam, lParam);
}
